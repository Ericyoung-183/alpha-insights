...
> **方法论索引合并 + Tier 3 报告篇幅强化**

### 方法论体系（V3-03）
- `methodology_mapping.md` 合并入 `methodology/_index.md`，消除双源重叠
- MECE 检查点补充框架维度覆盖 + N/A 维度显式标注
- `frameworks/_index.md` 新增 N/A 维度判断标准（弱相关 + 低影响双条件）
- SKILL.md Tier 2 加载点修复：Stage 3 ACH + Stage 5 第一性原理/Pre-mortem/ACH 延续

### 报告结构（V3-04）
- Tier 3 篇幅从 15-30 页提升至 20-35 页，核心章节 4-5 章 × 3-5 页
- 报告结构从六段式升级为七段式（新增盲区审查独立章节）
- 子结构 Tier 3 展开量强化：每章 ≥1 ECharts、每维度 ≥2 段、每层 So What 独立段落
- 新增 Tier 3 页面预算参考表（算术验证 min=20 / max=35）
