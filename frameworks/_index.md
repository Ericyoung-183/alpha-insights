...
| 下游 | 输出内容 | 使用方式 |
|------|---------|---------|
| Stage 2 research_definition | 选中的框架组合 + 层级关系 + 插入点 | 写入研究定义书 |
| Stage 3 research_plan | 框架要求的数据点 | 转化为搜索任务 |
| Stage 5 insights | 框架分析结果 | 洞察生成的结构化输入 |
| `methodology_mapping.md` | 框架组合确定后 | 自动匹配 Tier 1/Tier 2 方法论 |
